...
import com.cerner.sample.domain.Region;
import com.cerner.sample.repository.RegionRepository;
import com.cerner.sample.service.RegionService;
...
import static com.cerner.sample.web.rest.TestUtil.createFormattingConversionService;
...
public class RegionResourceIntTest {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getTest()).isEqualTo(DEFAULT_TEST);
    }
    ...
    public void updateRegion() throws Exception {
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getTest()).isEqualTo(UPDATED_TEST);
    }

    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="springBootSampleApp.region.home.createOrEditLabel">Create or edit a Region</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : regionEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="testLabel" for="test">
                    Test
                  </Label>
                  <AvField id="region-test" type="text" name="test" />
                </AvGroup>
